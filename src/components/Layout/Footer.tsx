        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Grid item xs={12} sm={6} md="auto">
              ...
              <Typography sx={{ color: '#aaa', maxWidth: '220px', lineHeight: 1.6 }}>
            ...
            <Grid item xs={12} sm={6} md="auto">
              ...
              {['Trung tâm hỗ trợ', 'Hướng dẫn đặt vé', 'Câu hỏi thường gặp', 'Liên hệ'].map(
                (item) => (
                  <Link
                    key={item}
                    href="#"
            ...
            <Grid item xs={12} sm={6} md="auto">
              ...
              {['Giới thiệu', 'Tin tức', 'Tuyển dụng', 'Điều khoản'].map((item) => (
                <Link
                  key={item}
                  href="#"
                  sx={{
